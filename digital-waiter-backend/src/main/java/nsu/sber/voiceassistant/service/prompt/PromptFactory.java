    ...
    public static String buildPromptForInvalidAddItem(String menu) {
        return String.format(
                "Пользователь хочет добавить несколько блюд в корзину. " +
                        "Проанализируй текст пользователя и вытащи КАЖДОЕ блюдо, его размер и количество.\n\n" +
                        ...
                        " 4. Верни quantity (число)." +
                        "Если пользователь сказал два три" + "4 — используй это число." +
                        "Если количество не указано — quantity = 1." +
                        "5. Если блюдо не найдено в меню, itemId = null (строкой, без кавычек).\n\n" +

                        "Ответ должен быть строго в формате JSON, строго с полями 'itemId', 'sizeId', 'quantity':\n" +
                        "{\n" +
                        "  \"items\": [\n" +
                        "    { \"itemId\": null, \"sizeId\": null, \"quantity\": 1 }\n" +
                        "  ]\n" +
                        "}\n\n" +
                        "Никаких других полей. Только itemId, sizeId, quantity — строго так, с точным регистром.\n",
                menu
        );
    }
