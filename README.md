...
- Разделение блюд между гостями
- Оформление заказа
- Вызов официанта
- Общение с интеллектуальным помощником посредством голоса и текста
- Получение рекомендаций от интеллектуального помощника
...
- Работа с WebSocket (используется для уведомления Frontend о статусах асинхронных операций и заказов)
